let config = {
	...
	imagesCoin: ["images/Centaur-icon.png", "images/Elf-icon.png", "images/Grim-Reaper-icon.png", "images/King-icon.png", "images/Knight-icon.png", "images/Orc-icon.png", "images/Sorceress-Witch-icon.png", "images/Werewolf-icon.png"],
